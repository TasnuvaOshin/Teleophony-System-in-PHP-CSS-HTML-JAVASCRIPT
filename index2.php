...
<body>
<h1>Fill up the Process_Table</h1>
<ul>
...
<input type="Button" name="length[]" value="End Time"  class="in" required></input>
...
$(document).ready(function(){
 ...
 i++;
 $('#dynamic').append('<tr id="row'+i+'"><td><input type="Number" name="name[]" class="in" placeholder="Enter The value of From" required></input></td><td><input type="Number" name="totel[]" class="in" placeholder="Enter The value of TO" required></input></td><td><input type="Number" name="length[]" class="in" placeholder="Enter The End Time" required></input></td><td><button type="button" name="remove" id="'+i+'" class="btn_remove">Remove</button></td></tr>');
 });
